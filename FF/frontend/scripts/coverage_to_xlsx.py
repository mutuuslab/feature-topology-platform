...
COVERAGE = {
    ...
    'FR-POL':  ('부분',  ['Policy Lifecycle', 'Control Point']),
    'FR-AUTH': ('백엔드', ['Runtime(Ops)']),
    'FR-ROL':  ('부분',  ['OTA Campaign']),
    'FR-EXP':  ('완료',  ['실험·효과검증']),
    'FR-PVER': ('부분',  ['Policy Lifecycle']),
    'FR-EXC':  ('완료',  ['예외 정책']),
    'FR-CON':  ('완료',  ['정책 충돌']),
    'FR-RBAC': ('완료',  ['Permissions']),
    'FR-AUD':  ('완료',  ['Audit Log']),
    'FR-VAR':  ('완료',  ['Variant Matrix']),
    'FR-SUP':  ('부분',  ['Feature Detail(Control)']),
    'FR-TGT':  ('부분',  ['Variant Matrix', 'Campaign']),
    'FR-RTE':  ('백엔드', ['Ops Dashboard']),
    'FR-LPC':  ('백엔드', ['Ops Dashboard']),
    'FR-SFD':  ('부분',  ['Kill Switch·Safe Default']),
    'FR-CRC':  ('완료',  ['컴플라이언스']),
    'FR-DSV':  ('부분',  ['Release Readiness']),
    'FR-KSW':  ('완료',  ['Kill Switch']),
    'FR-RBK':  ('완료',  ['Rollback(단계복구)']),
    'FR-OPD':  ('부분',  ['Telemetry', 'Ops']),
    'FR-QFL':  ('부분',  ['Telemetry']),
    'FR-EVT':  ('부분',  ['Telemetry', 'Audit']),
    'FR-VOC':  ('부분',  ['Incident']),
    'FR-RDD':  ('완료',  ['CI/CD']),
    'FR-CICD': ('완료',  ['CI/CD']),
    'FR-PDA':  ('부분',  ['Campaign', 'CI/CD']),
    'FR-QGV':  ('완료',  ['품질 Gate']),
    'FR-AGW':  ('부분',  ['Connector Hub']),
    'FR-LGCY': ('부분',  ['Connector Hub']),
    'FR-DSYN': ('부분',  ['Sync Logs']),
    'FR-SDVI': ('부분',  ['Connector Hub']),
    'FR-BIL':  ('완료',  ['과금 연계']),
    'FR-GLB':  ('완료',  ['글로벌 출시']),
    'FR-FSP':  ('완료',  ['현장 지원']),
    'FR-BIZ':  ('완료',  ['사업 지표']),
    'FR-PVL':  ('부분',  ['Consistency Console']),
