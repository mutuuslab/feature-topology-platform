...
export const coverage: Record<string, Cov> = {
  ...
  'FR-TGT':  { status: '부분', screens: [{ to: '/variants/FEAT-BDC-001', label: 'Variant Matrix' }, { to: '/ops/campaign', label: 'Campaign' }] },
  'FR-RTE':  { status: '백엔드', screens: [{ to: '/ops/FEAT-BDC-001', label: 'Ops Dashboard' }] },
  ...
  // 04 배포·운영·데이터
  'FR-OPD':  { status: '부분', screens: [{ to: '/ops/telemetry', label: 'Telemetry' }, { to: '/ops/FEAT-BDC-001', label: 'Ops' }] },
